export const abilityMechanics = [
  ...
  { key: 'evelynn-e', champion: '伊芙琳', aliases: ['Evelynn'], slot: 'E', skill: 'Whiplash', onHit: true, spellEffects: true },
  { key: 'evelynn-e-empowered', champion: '伊芙琳', aliases: ['Evelynn'], slot: '强化 E', skill: 'Empowered Whiplash', onHit: true, spellEffects: true },
  ...
  { key: 'fizz-q', champion: '菲兹', aliases: ['Fizz', '小鱼人'], slot: 'Q', skill: 'Urchin Strike', onHit: true, spellEffects: true },
